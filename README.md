...
### MVP
##### Create a short summary to provides insight to be above questions.  Use charts, visualizations, or words depending on which best communicates your team's findings.  Only 1 summary is required per group.  The team lead should Email the summary to the instructor by the deadline.

##### Suggestions:
##### - Work together until you have an understand of the data and its format.
##### - After the entire team is comfortable with the data, divide the work.
##### - Don't be afraid to have 2 people complete the same task to verify results.
##### - Maintain constant communication with teammates throughout the project
##### - Be mindful of the deadline. Save some time to review your summary as a team prior to submitting.
